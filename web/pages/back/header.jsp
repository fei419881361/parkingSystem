    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="pages/back/lenbook/LenbookServlet/insertPro"><i class="fa fa-desktop "></i>保养登记 </a>
                    </li>
                    <li>
                        <a href="pages/back/lenbook/LenbookServlet/listSplit"><i class="fa fa-desktop "></i>保养记录 </a>
                    </li>
                </ul>
            </li>
        </ul>
